...
using CameraMapApp.Startup;
using CameraMapApp.Contracts;
using CameraMapApp.Services;
using CameraMapApp.ViewModels;

namespace CameraMapApp
{
    public class AppBootstrapper : BootstrapperBase
    {
        ...
        protected override void Configure()
        {
            ...
            batch.AddExportedValue<IArcGisSdkCreate>(new ArcGisSdkCreate());

            //batch.AddExportedValue<IMap>(new MapViewModel());
